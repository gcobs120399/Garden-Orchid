...
//未加限制顯示筆數的SQL敘述句
$query_RecFlower = "SELECT * FROM `equipment` WHERE `e_pattern`<>'資材' AND `e_user`='".$_SESSION["loginMember"]."' ";
  ...
  <tr>
    <td class="tdbline"><table width="100%" border="0" cellspacing="0" cellpadding="10">
      <tr valign="top">
        ...
        <li role="presentation"><a href="SM.php">資材</a></li>
         <li role="presentation" class="active"><a href="SM1.php">耗材</a></li>
        </ul></div>
