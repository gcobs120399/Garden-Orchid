  ...
  <!-- 最新編譯和最佳化的 JavaScript -->
   ...
   //中間上方監控
    $(document).ready(function() {
            ...
            $.getJSON("data_center.php", function(json) {
                options.xAxis.categories = json[3]['h_jointime'];
   ...
   //中間監控
    $(document).ready(function() {
            ...
            $.getJSON("data_center1.php", function(json) {
   ...
   //中間下方監控
    $(document).ready(function() {
            ...
            $.getJSON("data_center2.php", function(json) {
                options.xAxis.categories = json[3]['data'];
                options.series[0] = json[0];
                options.series[1] = json[1];
                options.series[2] = json[2];
...
<input type="button" class="btn btn-primary" style="width:50px;" value="中" onclick="location.href='history_center.php'">
<input type="button" class="btn btn-info" style="width:50px;" value="右" onclick="location.href='history_right.php'">
</div>
<div id="container" style="min-width: 400px; height: 400px; margin: 0 auto" class="col-xs-12"></div><!--折線圖-->
<hr>
<div id="container1" style="min-width: 400px; height: 400px; margin: 0 auto" class="col-xs-12"></div><!--折線圖-->
<hr>
<div id="container2" style="min-width: 400px; height: 400px; margin: 0 auto" class="col-xs-12"></div><!--折線圖-->
<div class="col-xs-12">
