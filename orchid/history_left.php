  ...
  <!-- 最新編譯和最佳化的 JavaScript -->
   ...
   //左邊上方監控
    $(document).ready(function() {
            ...
            $.getJSON("data_left.php", function(json) {
   ...
   //左邊下方監控
    $(document).ready(function() {
            ...
            $.getJSON("data_left1.php", function(json) {
                options.xAxis.categories = json[3]['data'];
                options.series[0] = json[0];
                options.series[1] = json[1];
                options.series[2] = json[2];
...
<input type="button" class="btn btn-primary" style="width:50px;" value="左" onclick="location.href='history_left.php'">
